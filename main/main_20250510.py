...
ASSISTANT_SCRIPT = 'xxxxxxxxxx'
SSH_KEY_PATH = config.SSH_KEY_PATH
DEV_MODE_FILE = 'xxxxxxxxxxxxxxxxxxxx'
# ===========================
...
def cleanup_gpio():
    print("🪝 GPIO解放中...")
    try:
        if 'button' in globals() and hasattr(button, 'when_pressed'):
    ...
    try:
        ...
        pids_output = subprocess.run(["sudo", "lsof", "-t", "xxxxxxxx"], capture_output=True, text=True)
